...
namespace KardesAile.Database.Migrations
{
    ...
    [Migration("20230213072637_AddCountryCodeStateCodeColumns")]
    partial class AddCountryCodeStateCodeColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KardesAile.Database.Entities.Moderator", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_moderator_email");

                    b.ToTable("moderator", "kardesaile");
                });
            ...
            modelBuilder.Entity("KardesAile.Database.Entities.Match", b =>
                {
                    ...
                    b.HasOne("KardesAile.Database.Entities.DisasterVictim", "Victim")
                        .WithOne("Match")
                        .HasForeignKey("KardesAile.Database.Entities.Match", "VictimId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
