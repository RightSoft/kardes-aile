...
export default class AddDisasterVictimComponent extends AddPageTitle {
  ...
  constructor(private disasterVictimService: DisasterVictimService, private addressService: AddressService, private navigationService: NavigationService, private route: ActivatedRoute) {
